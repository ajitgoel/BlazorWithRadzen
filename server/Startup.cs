...
using RadzenCrm3.Authentication;
...
namespace RadzenCrm3
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RadzenCrm3.Data.CrmContext>(options =>
            {
              options.UseSqlServer(Configuration.GetConnectionString("CRMConnection"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ApplicationIdentityDbContext identityDbContext)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                oDataBuilder.EntitySet<RadzenCrm3.Models.Crm.Contact>("Contacts");
                oDataBuilder.EntitySet<RadzenCrm3.Models.Crm.Opportunity>("Opportunities");
                oDataBuilder.EntitySet<RadzenCrm3.Models.Crm.OpportunityStatus>("OpportunityStatuses");
                oDataBuilder.EntitySet<RadzenCrm3.Models.Crm.Task>("Tasks");
                oDataBuilder.EntitySet<RadzenCrm3.Models.Crm.TaskStatus>("TaskStatuses");
                oDataBuilder.EntitySet<RadzenCrm3.Models.Crm.TaskType>("TaskTypes");
