...
namespace RadzenCrm3.Pages
{
    public partial class AddOpportunityStatusComponent : ComponentBase
    {
        ...
        RadzenCrm3.Models.Crm.OpportunityStatus _opportunitystatus;
        protected RadzenCrm3.Models.Crm.OpportunityStatus opportunitystatus
        {
            get
            {
        ...
        {
            opportunitystatus = new RadzenCrm3.Models.Crm.OpportunityStatus(){};
        }

        protected async System.Threading.Tasks.Task Form0Submit(RadzenCrm3.Models.Crm.OpportunityStatus args)
        {
            try
            {
